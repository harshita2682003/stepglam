...
/********* Product Section & Product Page Slider *********/
var swiperProMain = null;
var swiperProduct = null;
var isSwiperProMainInitialized = false;
var isSwiperProductInitialized = false;
...
function destroySwiper(swiperInstance) {
  if (swiperInstance !== null && swiperInstance.destroy) {
    swiperInstance.destroy(true, true); // Ensure swiperInstance is destroyed properly
    swiperInstance = null;
  }
}
